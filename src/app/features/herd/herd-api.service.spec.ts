...
describe('HerdApi', () => {
  ...
  it('usa o endpoint atômico real para lote',()=>{const {client,api}=setup();const body={operationId:'stable',animals:[{id:'a',expectedVersion:1}]};api.moveBatch(body).subscribe();expect(client.post).toHaveBeenCalledWith('/api/v1/herd/movements/batch',body,true);});
